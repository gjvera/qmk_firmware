...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LAYOUT(
            ...
            M(6), KC_QUOTE, KC_S, KC_D, TD(LPAREN_BRACE), TD(RPAREN_BRACE), KC_BSLS, KC_MINS, KC_4, KC_5, KC_6, KC_TRNS, 
    ...
    LAYOUT(
            ...
            KC_F1, KC_MS_BTN2, KC_MS_UP, KC_MS_BTN1, KC_WH_D, KC_F6, KC_F7, KC_VOLD, KC_MUTE, KC_VOLU, KC_F11, KC_F12, 
            KC_TRNS, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT, KC_WH_U, KC_TRNS, KC_TRNS, KC_MPRV, KC_MPLY, KC_MNXT, KC_TRNS, KC_DEL, 
